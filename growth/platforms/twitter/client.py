...
REQUEST_DELAY = float(os.environ.get("GROWTH_TWITTER_DELAY", "8.0"))

# How long to wait (seconds) after a 429 before retrying.
RATE_LIMIT_BACKOFF = float(os.environ.get("GROWTH_TWITTER_BACKOFF", "90.0"))
...
class TwitterClient:
    ...
    Usage::
        ...
        client = TwitterClient(cookie_path=Path("~/.config/growth/identities/twitter/handle/cookies.json"))
