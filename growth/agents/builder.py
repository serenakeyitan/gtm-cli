...
from growth.agents.github_tools import github_create_repo, github_create_pr
...
async def run_builder(
    ...
    prompt = (
        ...
        f"IMPORTANT: All git operations must use the serenakeyitan GitHub account.\n"
        f"Before your first commit, run:\n"
        f"  git config user.name 'serenakeyitan'\n"
        f"  git config user.email 'serenakeyitan@users.noreply.github.com'\n\n"
        f"Instructions:\n"
