...
That's ~19 tools, each with a typed schema generated from `Module.param_schema`. No new "verb" wrappers. The agent picks the right primitive based on what its skill tells it.
