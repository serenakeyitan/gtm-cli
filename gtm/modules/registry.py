...
from gtm.modules.base import Module
...
def _ensure_loaded() -> None:
    ...
    _safe_import("gtm.modules.sources")
    _safe_import("gtm.modules.filters")
    _safe_import("gtm.modules.transforms")
    _safe_import("gtm.modules.actions")
    _safe_import("gtm.modules.monitors")
    _safe_import("gtm.modules.control")
    _safe_import("gtm.modules.agents")

    # Register strategy files as 'strategy/*' modules
    try:
        from gtm.modules.agents.strategy_module import register_strategy_modules
